...
export default {
  ...
  "settings.general_card_advanced": "Advanced",
  "settings.general_card_advanced_desc": "Runtime, engine, and developer options.",
  "settings.general_card_ai": "AI Providers",
  "settings.general_card_ai_desc": "Connect services that provide AI models.",
  "settings.general_card_appearance": "Appearance",
  "settings.general_card_appearance_desc": "Theme, font size, and display.",
  "settings.general_card_cloud": "Cloud",
  "settings.general_card_cloud_desc": "OpenWork Cloud account and organization.",
  "settings.general_card_environment": "Environment",
  "settings.general_card_environment_desc": "Environment variables and paths.",
  "settings.general_card_extensions": "Extensions",
  "settings.general_card_extensions_desc": "MCPs, skills, plugins, and integrations.",
  "settings.general_card_permissions": "Permissions",
  "settings.general_card_permissions_desc": "Authorized folders and file access.",
  "settings.general_card_preferences": "Preferences",
  "settings.general_card_preferences_desc": "Default model, reasoning, and compaction.",
  "settings.general_card_recovery": "Recovery",
  "settings.general_card_recovery_desc": "Reset onboarding and clear data.",
  "settings.general_card_updates": "Updates",
  "settings.general_card_updates_desc": "App version and update channel.",
  "settings.general_group_help": "Help",
  ...
  "settings.shell_app_name_field_label": "App name",
  "settings.shell_app_name_label": "Change application name",
  "settings.shell_app_name_unavailable": "Changing the application name is not available yet.",
  ...
  "settings.shell_defaults_all": "All settings are at their defaults.",
  "settings.shell_defaults_customized": "Some settings have been customized.",
  "settings.shell_docs_button_desc": "Show a link to your documentation.",
  "settings.shell_docs_button_label": "Display documentation link",
  ...
  "settings.shell_feedback_button_desc": "Show a button for submitting feedback.",
  "settings.shell_feedback_button_label": "Display feedback button",
  "settings.shell_hide_warning": "Anything you hide is still available via the command palette (Cmd+K).",
  ...
  "settings.shell_notifications_desc": "A bell in the header collecting updates from OpenWork Cloud and your workspaces.",
  "settings.shell_notifications_label": "Display notifications",
  "settings.shell_org_desc": "These settings are managed by your organization via OpenWork Cloud.",
  "settings.shell_org_title": "Organization-wide settings",
  "settings.shell_org_warning": "These settings can only be changed by your organization admin. Contact your admin to make changes.",
